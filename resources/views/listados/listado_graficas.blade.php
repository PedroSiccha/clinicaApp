...
<br/>
<div class="box box-primary" style="width:100%; height:450px;" onload="cargar_grafica_pie()">
		<div class="box-header">
		</div>
...
window.addEventListener('load', cargar_grafica_pie, false);
...
var url = "grafica_tipoCita";
$.get(url,function(resul){
var datos= jQuery.parseJSON(resul);
var consultas=datos.consulta;
//alert(consultas);
	
	options.name.data.push( "Consulta" );
	options.y.push(consultas);
